...
public class CadastroUsuarioActivity extends AppCompatActivity {
    ...
    private LoginUsuario user = new LoginUsuario();
        ...
        btnCriar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(existsUsuario(edEmail.getText().toString()))
                    ...
                    cadUsuario.child(String.valueOf(childrenCount + 1)).child("usuario").setValue(user.getUsuario());
                    cadUsuario.child(String.valueOf(childrenCount + 1)).child("hash").setValue(user.getHash());
                    cadUsuario.child(String.valueOf(childrenCount + 1)).child("salt").setValue(user.getSalt());
                    Intent intent = new Intent(CadastroUsuarioActivity.this, InicialLogadoActivity.class);
