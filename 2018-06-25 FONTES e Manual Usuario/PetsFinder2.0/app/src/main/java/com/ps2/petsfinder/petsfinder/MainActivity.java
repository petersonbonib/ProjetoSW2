...
import static com.ps2.petsfinder.petsfinder.PFUtil.setNomeUsuario;
...
public class MainActivity extends AppCompatActivity implements Runnable{
    ...
    private List<LoginUsuario> listLoginUsuario;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (listLoginUsuario == null)
            listLoginUsuario = new ArrayList<>();
        ...
        login.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for(int i = 1; i <= dataSnapshot.getChildrenCount(); i++){
                    ...
                    DataSnapshot user = dataSnapshot.child(String.valueOf(i));
                    Object name = user.child("usuario").getValue();
                    Object hash = user.child("hash").getValue();
                    Object salt = user.child("salt").getValue();

                    loginUsuario.setUsuario(name.toString());
                    loginUsuario.setHash(hash.toString());
                    loginUsuario.setSalt(salt.toString());
            ...
            public void onClick(View view) {
                if (validaCampos()){
                    if(comparaSenha(edEmail.getText().toString())){
                        ...
                        finish();
                        setNomeUsuario(edEmail.getText().toString());
                    }
                }
            }
        });
    ...
    public void adicionaUsuariosLista(){
